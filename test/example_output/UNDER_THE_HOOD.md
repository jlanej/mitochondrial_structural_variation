...
| splicebreak2 | yes | no(11) | native_rc=0 junctions=1 del4977_junc=1 last_stage=? steps_failed=? pileup=NA basecounts=NA coverage=NA modjunc=NA largedel=NA result_bytes=1743 calls=1  |
