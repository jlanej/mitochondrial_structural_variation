...
| splicebreak2 | no | no(1) | native_rc=127 junctions=0 del4977_junc=0 last_stage=? steps_failed=? pileup=NA basecounts=NA coverage=NA modjunc=NA largedel=NA result_bytes=0 calls=0  |
